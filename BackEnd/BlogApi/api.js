...
//   if (id === 1) {
//     // Redirect to the post details page if the post is default (id = 1)
...
//       title: req.body.title || postObj.title,
//       content: req.body.content || postObj.content,
//       imageUrl: generateImageUrl(req.body.title || postObj.title),
//     };

//     posts[postIndex] = updatedPost;
//     res.redirect(`/posts/${postObj.id}`);  // Correct redirect to the post's detail page
//   } else {
//     res.status(404).json({ message: "Post not found" });
//   }
// });
...
//   if (index !== -1) {
//     posts.splice(index, 1);
//     res.redirect("/");  // Redirect to home after deleting the post
//   } else {
//     res.status(404).json({ message: "Post not found" });
//   }
// });
